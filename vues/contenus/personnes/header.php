...
<?php endif; ?>
		<aside>
			<h1 class="left"> <a href="/personnes/detail/<?php echo $perso->id_personne?>"><?php echo $perso->civilite ?> <?php echo $perso->prenom ?> <?php echo $perso->nom ?> <?php echo ( isset($nom_jeune_fille) ? $nom_jeune_fille : 0) ?></a></h1><button type="button" form-action="<?php echo $form_action ?>" form-type="ajouter" form-id="<?php echo $id ?>" class="edit"  title="Modifier"></button>
