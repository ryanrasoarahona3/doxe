...
function maj($chaine)
{
	...
	$chaine = strtr($chaine, 'äâàáåãéèëêòóôõöøìíîïùúûüıñçşÿæ½ğø', 'ÄÂÀÁÅÃÉÈËÊÒÓÔÕÖØÌÍÎÏÙÚÛÜİÑÇŞİÆ¼ĞØ');
	$chaine=utf8_encode($chaine);
	return $chaine;
}
function firstmaj($mot)
{
	$mot=trim($mot);$maj=$mot[0];$maj = strtr($maj,'äâàáåãéèëêòóôõöøìíîïùúûüıñçşÿæ½ğø', 'ÄÂÀÁÅÃÉÈËÊÒÓÔÕÖØÌÍÎÏÙÚÛÜİÑÇŞİÆ¼ĞØ');
