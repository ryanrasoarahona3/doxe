...
if (!empty($asso->commandes)) {
	foreach ($asso->commandes as $order) {
...
if (count($asso->commandes) > $i) {
		$plus='<a href="#" class="right plus" form-action="personnes" form-type="achats" form-id="'.$asso->id_association.'">> Voir '.(count($asso->commandes)-$limite).' plus</a>';
} 
